...
function (_Slider) {
  ...
  function MainSlider(btns) {
    ...
    _this.next = document.querySelectorAll('.nextmodule');
    _this.prev = document.querySelectorAll('.prevmodule');
    return _this;
  }
...
var Slider = function Slider() {
  ...
  this.prev = document.querySelector(prev), this.next = document.querySelector(next), this.slideIndex = 1;
